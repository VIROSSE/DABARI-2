...
import VisionBg from '../../../../../public/banners/trading-bg.png'
import VisionBgMobile from '../../../../../public/banners/trading-bg-mobile.png'

import Image from 'next/image'
import { tradingFeature } from '../../../../../utils/CONSTANTS'
                        ...
                        <div className='flex w-full    flex-col z-20 m-auto  justify-center items-center '>
                            <div className='max-w-xl  md:text-justify space-y-5 md:space-y-10 '>
                                <div className=' text-2xl font-semibold  text-left md:text-5xl  '>
                                    <h1 className='drop-shadow'>Trading</h1>
                                </div>
                                <div className=' text-base font-semibold  text-left md:text-xl  '>
                                    <h1 className='drop-shadow'>{`Mali's Golden Trade Finance Frontier`}</h1>
                                </div>
